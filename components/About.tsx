...
export function About() {
  return (
    <section
      ...
      className="section-tone section-tone-about relative scroll-mt-28 min-h-svh py-24 sm:py-32"
    >
      <Container className="relative z-10 grid min-h-[calc(100svh-12rem)] items-center gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(0,28rem)] lg:gap-16">
